...
public class AdmRegistration extends Registration {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((admRegistrationId == null) ? 0 : admRegistrationId.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (admRegistrationId == null) {
            ...
            return admRegistrationId.equals(other.admRegistrationId);
    }

    @Override
    public String getXml() {
        return ADM_NATIVE_REGISTRATION1 + getTagsXml() + ADM_NATIVE_REGISTRATION2 + admRegistrationId
