...
public class FcmRegistration extends Registration {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((fcmRegistrationId == null) ? 0 : fcmRegistrationId.hashCode());
        return result;
    }
    ...
    public String getXml() {
        return FCM_NATIVE_REGISTRATION1 + getTagsXml() + FCM_NATIVE_REGISTRATION2 + fcmRegistrationId
