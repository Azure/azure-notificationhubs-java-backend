...
public class WindowsTemplateRegistration extends WindowsRegistration {
    ...
    /**
     * Creates a WNS template registration with channel URI, body template and
     * headers.
     *
    ...
    public String getXml() {
        return WNS_TEMPLATE_REGISTRATION1 + getTagsXml() + WNS_TEMPLATE_REGISTRATION2 + channelUri.toString()
                + WNS_TEMPLATE_REGISTRATION3 + bodyTemplate + WNS_TEMPLATE_REGISTRATION4 + getHeadersXml()
