...
public class HttpClientManager {
    ...
    private static void initializeHttpAsyncClient() {
        synchronized (HttpClientManager.class) {
            if (httpAsyncClient == null) {
                ...
                CloseableHttpAsyncClient client = HttpAsyncClientBuilder.create().setDefaultRequestConfig(config)
                        .build();
                client.start();
        ...
        synchronized (HttpClientManager.class) {
            if (HttpClientManager.httpAsyncClient == null) {
                ...
                throw new RuntimeException(
                        "Cannot setHttpAsyncClient after having previously set, or after default already initialized from earlier call to getHttpAsyncClient.");
            }
        }
    }

    // Sets the timeout in milliseconds used when requesting a connection from the
    // connection manager.
    public static void setConnectionRequestTimeout(int timeout) {
        if (HttpClientManager.httpAsyncClient == null) {
            ...
            throw new RuntimeException(
                    "Cannot setConnectionRequestTimeout after previously setting httpAsyncClient, or after default already initialized from earlier call to getHttpAsyncClient.");
        }
    }
    ...
    public static void setConnectTimeout(int timeout) {
        if (HttpClientManager.httpAsyncClient == null) {
            ...
            throw new RuntimeException(
                    "Cannot setConnectTimeout after previously setting httpAsyncClient, or after default already initialized from earlier call to getHttpAsyncClient.");
        }
    }
    ...
    public static void setSocketTimeout(int timeout) {
        if (HttpClientManager.httpAsyncClient == null) {
            ...
            throw new RuntimeException(
                    "Cannot setSocketTimeout after previously setting httpAsyncClient, or after default already initialized from earlier call to getHttpAsyncClient.");
        }
    }
}
