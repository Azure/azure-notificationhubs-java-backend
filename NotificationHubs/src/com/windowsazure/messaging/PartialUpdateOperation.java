...
public class PartialUpdateOperation {
	...
	/**
	 * Creates a partial update operation with an operation and path to the property to modify.
	...
	/**
	 * Creates a partial update operation with an operation, a path to the property to modify and the value.
	 * @param operation The update operation type
	 * @param path The path to the property to patch.
