 ...
 * This interface will be removed in favor of the NotificationHubClient interface and should not be used directly.
 */
public interface INotificationHub {
	 ...
	 * Gets an installation by the given installation ID.
	 * @param installationId The installation ID for the installation to get.
	 * @param callback A callback, when invoked, returns the matching installation by the installation ID.
	 */
	 ...
	 * Submits a notification hub job such as import or export.
	 * @param job The notification hubs job to submit.
	 * @param callback A callback, when invoked, returns the notification job with status.
	 */
	 ...
	 * Gets a notification hub job by the job ID.
	 * @param jobId The job ID of the notification hub job to get.
	 * @param callback A callback, when invoked, returns the notification hub job with the matching job ID.
	 */
	...
	/**
	 * Gets all notification hub jobs for this namespace.
	 * @param callback A callback, when invoked, returns all notification hub jobs for this namespace.
	 */
	 ...
	 * Gets notification telemetry by the notification ID.
	 * @param notificationId The notification ID for the telemetry.
	 * @param callback A callback, when invoked, returns the notification telemetry for the given notification.
	 */
	 ...
	 * ETag and registration ID are ignored
	 * 
	 * @return The created registration containing the read-only parameters (registration ID, ETag, and expiration time).
	 * @throws NotificationHubsException Thrown if there is a client error.
	 */
	 ...
	 * ETag and registration ID are ignored
	 *
	 * @param callback A callback when invoked returns created registration containing the read-only parameters
	 ...
	 *
	 * @param registration A registration object containing the description of the registration to update.
	 * The registration ID must be populated.
	 * @param callback A callback when invoked, returns the updated registration containing the read-only parameters (registration ID, ETag, and expiration time).
	 */
	...
	/**
	 * Deletes a registration with the given registration containing a populated registrationId.
	 * 
	 * @param registration The registration containing the registrationId field populated.
	 * @throws NotificationHubsException Thrown if there is a client error.
	 */
	 ...
	 *
	 * @param registrationId The ID for the registration to retrieve.
	 * @param callback A callback, when invoked, returns the registration with the ID matching the given registration ID.
	 */
	...
	/**
	 * Return all registrations in the current notification hub.
	 * @param callback The callback when invoked, returns a collection containing registrations.
	 */
	 ...
	 * @param top The maximum number of registrations to return (max 100)
	 * @param continuationToken If not-null, continues iterating through a previously requested query.
	 * @param callback A callback when invoked returns a collection containing the registrations.
	 */
	 ...
	 *
	 * @param tag The tag to search for registrations.
	 * @param callback A callback, when invoked, returns a collection of registrations with the given tag.
	 */
	 ...
	 * Returns all registration with a specific channel (e.g. ChannelURI, device token)
	 * @param channel The channel URI, device token or other unique PNS identifier.
	 * @param callback A callback, when invoked, returns a collection of registrations with matching channels.
	 */
	 ...
	 *
	 * @param notification The notification to send to all eligible registrations.
	 * @param callback A callback, when invoked, returns a notification outcome with the tracking ID and notification ID.
	 */
	 ...
	 * 
	 * @param notification The notification to send to the audience with the specified tags.
	 ...
	 * 
	 * @param notification The notification to send to the audience that matches the specified tag expression.
	 ...
	 * @param notification The notification to send at the given time.
	 * @param tagExpression The tag expression associated with the notification targeting.
	 * @param scheduledTime The scheduled time for the notification.
	 * @return A notification outcome with the tracking ID and notification ID.
	 * @throws NotificationHubsException Thrown if there is a client error.
	 */
