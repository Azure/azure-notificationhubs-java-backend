...
/**
 * @deprecated use
 *             {@link com.windowsazure.messaging.FcmTemplateRegistration#FcmTemplateRegistration()}
 *             instead.
 */
...
public class GcmTemplateRegistration extends GcmRegistration {
    ...
    public GcmTemplateRegistration(String registrationId, String gcmRegistrationId, String bodyTemplate) {
    ...
    public String getXml() {
        return GCM_TEMPLATE_REGISTRATION1 + getTagsXml() + GCM_TEMPLATE_REGISTRATION2 + gcmRegistrationId
                + GCM_TEMPLATE_REGISTRATION3 + bodyTemplate + GCM_TEMPLATE_REGISTRATION4;
    }
}
