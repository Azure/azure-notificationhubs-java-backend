...
public class NotificationHubJob {
	 ...
	 * @param createdAt The created at time for the notification hub job to be parsed as a date.
	 */
	...
	/**
	 * Sets the updated at time for the notification hub job as a string parsed to be a date.
