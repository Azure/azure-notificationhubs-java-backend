...
public class FcmTemplateRegistration extends FcmRegistration {
    ...
    /**
     * Creates an FCM template registration with registration ID, FCM registration
     * ID and body template.
     *
     * @param registrationId    The registration ID.
     * @param fcmRegistrationId The FCM registration ID.
     * @param bodyTemplate      The body template.
     */
    public FcmTemplateRegistration(String registrationId, String fcmRegistrationId, String bodyTemplate) {
        super(registrationId, fcmRegistrationId);
        this.bodyTemplate = bodyTemplate;
    }

    /**
     * Creates an FCM template registration with FCM registration ID and body
     * template.
     *
     * @param fcmRegistrationId The FCM registration ID.
     * @param bodyTemplate      The body template.
    ...
    public String getXml() {
        return FCM_TEMPLATE_REGISTRATION1 + getTagsXml() + FCM_TEMPLATE_REGISTRATION2 + fcmRegistrationId
                + FCM_TEMPLATE_REGISTRATION3 + bodyTemplate + FCM_TEMPLATE_REGISTRATION4;
    }
}
