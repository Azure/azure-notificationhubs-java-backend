 ...
 *
 * @deprecated use
 *             {@link com.windowsazure.messaging.FcmRegistration#FcmRegistration()}
 *             instead.
 */
...
public class GcmRegistration extends Registration {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((gcmRegistrationId == null) ? 0 : gcmRegistrationId.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (gcmRegistrationId == null) {
            ...
            return gcmRegistrationId.equals(other.gcmRegistrationId);
    }

    @Override
    public String getXml() {
        return GCM_NATIVE_REGISTRATION1 + getTagsXml() + GCM_NATIVE_REGISTRATION2 + gcmRegistrationId
