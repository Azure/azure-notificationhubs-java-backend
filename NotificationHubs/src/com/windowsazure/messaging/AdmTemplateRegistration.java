...
public class AdmTemplateRegistration extends AdmRegistration {
    ...
    /**
     * Creates a new instance of the ADM template registration with the registration
     * ID, ADM registration ID and template body.
     *
    ...
    /**
     * Creates an ADM template registration with an ADM registration ID and template
     * body.
     *
     * @param admRegistrationId The ADM registration ID.
     * @param bodyTemplate      The template body.
    ...
    public String getXml() {
        return ADM_TEMPLATE_REGISTRATION1 + getTagsXml() + ADM_TEMPLATE_REGISTRATION2 + admRegistrationId
                + ADM_TEMPLATE_REGISTRATION3 + bodyTemplate + ADM_TEMPLATE_REGISTRATION4;
    }
}
