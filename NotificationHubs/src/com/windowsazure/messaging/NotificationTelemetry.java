...
public class NotificationTelemetry {
	...
	/**
	 * Sets the notification status from a string to be parsed as a NotificationStatus.
	 ...
	 * @param startTime The notification start time as a string to be parsed as a date/
	 */
